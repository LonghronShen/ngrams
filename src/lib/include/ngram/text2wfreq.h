...
/**
 * This class utilizes WordNgrams and CharNgrams classes to generate and output
 * ngrams. Revisions: Feb 18, 2006. Jerry Yu Initial implementation
 */
...
public:
  ...
  void printOptions() {
    printf("ngramN %d, ngramType %s, inFileName %s, outFileName %s.\n", ngramN,
           ngramType == Config::CHAR_NGRAM ? "character" : "word",
           inFileName.c_str(), outFileName.c_str());
  }

  int getNgramN() { return ngramN; }

  int getNgramType() { return ngramType; }
