...
public:
   ...
   * get the default delimiters
   */
  static const char *getDefaultStopChars() { return " \n\r"; }
   ...
   */
  static utf8_string getOptionValue(utf8_string option, int argc,
                                    char *argv[]) {
    utf8_string value = "";
    utf8_string commandLine = "";
    for (int i = 0; i < argc; i++) {
      commandLine += " ";
      commandLine += utf8_string(argv[i]);
    }
   ...
   */
  static bool hasOption(utf8_string option, int argc, char *argv[]) {
    utf8_string s;
    for (int i = 0; i < argc; i++) {
      s.append(argv[i]);
    }
